...
public:
    ...
    struct mesh_header {
        ...
        uint32_t num_indices;
        uint32_t num_index_ranges; // 1 - 123 is a lot more compact than 1,2,3, 4,5,6,...
    };
private:
    blockloader& bl;
public:
    ...
    parasitic_vector<uint32_t> index_ranges;
	uint32_t vao;
	uint32_t buffers[6];
public:
#if 0
...
#if 0
//moving this into the convert_obj_blockloader.cpp file
// this is only needed when converting, the blockloading model loader should not depend on assimp
/**
