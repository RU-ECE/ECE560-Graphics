...
void glmain() {
	...
	do {
		...
		// connected triangles might be more efficient?
        // you will need DEGENERATE triangles, but it would work, BUT
		//glDrawArrays(GL_TRIANGLE_STRIP, 0, 3); // 3 indices starting at 0 -> 1 triangle
        // however, since colors cannot be shared, this only works when colors are the same
        glDrawArrays(GL_TRIANGLES, 0, ______); // number of triangles in your cube!
